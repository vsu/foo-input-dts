...
public:
    ...
    {
        return stream.is_in_sync();
    }
    bool is_new_stream()			const
    {
        return stream.is_new_stream();
    }
    bool is_frame_loaded()			const
    {
        return stream.is_frame_loaded();
    }

    Speakers get_spk()				const
    {
    ...
    {
        return stream.get_frame_size();
    }
    size_t get_frame_interval()		const
    {
        return stream.get_frame_interval();
    }
    ...
    {
        return stream.stream_info(buf, size);
    }
    HeaderInfo header_info()		const
    {
